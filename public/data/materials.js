...
(function() {
  ...
  window.WikiData.materials = {
    ...
    maxQuality: [
      ...
      { quality: { hu: "✨ Kitűnő", en: "✨ Excellent", ru: "✨ Отличное" },
        materials: { hu: "Arany, Gyémánt", en: "Gold, Diamond", ru: "Золото, Алмаз" }, bg: "rgba(255,220,0,0.10)" },
      { quality: { hu: "💎 Kiváló", en: "💎 Superior", ru: "💎 Превосходное" },
        materials: { hu: "Réz, Keménykő, Ezüst, Smaragd, Bronz, Ezüst-Réz ötvözet", en: "Copper, Hardstone, Silver, Emerald, Bronze, Silver Copper alloy", ru: "Медь, Твёрдый Камень, Серебро, Изумруд, Бронза, Серебряно-медный сплав" }, bg: "rgba(100,255,100,0.10)" },
