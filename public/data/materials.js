...
(function() {
  ...
  window.WikiData.materials = {
    ...
    durabilityMult: [
      ...
      { mult: "4×", materials: { hu: "Arany, Ezüst-Réz, Bronz, Ón, Kvarc, Pokolfenyő", en: "Gold, Silver-Copper, Bronze, Tin, Quartz, Netherbrick" }, tier: "t-gold", bg: null },
      { mult: "4×", materials: { hu: "Ezüst, Rozsdás Vas", en: "Silver, Rusted Iron" }, tier: "t-silver", bg: null },
      { mult: "4×", materials: { hu: "Réz", en: "Copper" }, tier: "t-copper", bg: null },
