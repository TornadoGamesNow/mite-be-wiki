...
(function() {
  ...
  window.WikiData.materials = {
    ...
    maxQuality: [
      ...
      { quality: { hu: "✨ Kitűnő", en: "✨ Superb" },
        materials: { hu: "Arany, Gyémánt", en: "Gold, Diamond" }, bg: "rgba(255,220,0,0.10)" },
      { quality: { hu: "💎 Kiváló", en: "💎 Excellent" },
        materials: { hu: "Réz, Keménykő, Ón, Ezüst, Smaragd, Bronz, Ezüst-Réz ötvözet", en: "Copper, Hardstone, Tin, Silver, Emerald, Bronze, Silver Copper alloy" }, bg: "rgba(100,255,100,0.10)" },
      { quality: { hu: "Jó", en: "Fine" },
      ...
      { quality: { hu: "Átlagos", en: "Average" },
        materials: { hu: "Alvilágkő, Üveg", en: "Netherrack, Glass" }, bg: null, muted: true },
    ...
    durabilityMult: [
      ...
      { mult: "4×", materials: { hu: "Réz, Ezüst, Bronz, Arany, Ezüst-Réz, Rozsdás Vas, Ón, Kvarc, Alvilágtégla", en: "Copper, Silver, Bronze, Gold, Silver Copper, Rusted Iron, Tin, Quartz, Nether Brick" }, tier: null, bg: null },
